...
public class AAA_MenuTeamTest extends BaseTest {
    ...
    @Test
    public void testVerifyTextFromAuthors() {
        final String textOliverSchade = "Oliver Schade works as European IT Project Manager for eBay International " +
                ...
                "technology, movies, whisky and his wife & baby... Besides ancient technology Oliver uses Linux " +
                "since Nov. 1992 and loves huge IT solutions like storage with TBytes, 64-node-clusters running " +
                "Linux and VMWare ESX clusters.";
        final String textGregorScheithauer = "Gregor Scheithauer studies Business Information Systems in Bamberg " +
                "with the emphasis of the business process modelling and the mobile & distributed application " +
                "systems. His interests lie in programming, especially Web-based business applications based on " +
                "J2EE and designing with HTML & CSS.";
